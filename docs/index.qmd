...
if 'PROJECT_ROOT_PATH' in globals() and PROJECT_ROOT_PATH:
    ...
    print(f"DEBUG (fig-conf-matrix): Checking dataset base directory: {dataset_base_dir}", file=sys.stderr)
    ...
    if dataset_base_dir.is_dir():
        ...
        if version_subdirs:
            ...
            print(f"DEBUG (fig-conf-matrix): Dynamically determined image path: {dynamic_image_path}", file=sys.stderr)
